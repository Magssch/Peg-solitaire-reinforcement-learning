...
class SimulatedWorld:
    ...
    def step(self, action: Tuple[int, int]) -> tuple:
        ...
        direction_vector = self.__edges[direction_index]
    ...
    def __index_from_coordinates(self, cell_position: Tuple[int, int]) -> Tuple[int, int]:
        """
    ...
    def __get_next_node(self, start_coordinates: Tuple[int, int], direction_vector: Tuple[int, int]) -> Tuple[int, int]:
